...
@Component({
  selector: 'app-editluong',
  templateUrl: './editluong.component.html',
  styleUrls: ['./editluong.component.css'],
})
export class EditluongComponent implements OnInit {
